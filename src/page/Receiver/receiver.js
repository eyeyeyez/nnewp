...
class Receiver extends Component {
  ...
  constructor() {
    ...
    this.state = {
      ...
      category: '',
      contact: '',
      img : 'https://static1.squarespace.com/static/5133d124e4b066ad532edd2c/t/539a8b01e4b07a1d748dce69/1402637057762/The-Ninth-Day-on-blank-book-cover-bigger.png?format=500w'
    };
  ...
  onSubmit(e) {
    ...
    publishPost(this.state.title, this.state.content, this.state.category, this.state.contact, this.state.img)
      .then(data => {
        if (data.status === 200) {
